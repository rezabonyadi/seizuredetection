...
def kaggle_data_2014_patient_specific(address):
    ...
    for subject in folders:
        ...
        for subject_test in folders:
            ...
            data = SeizureDataRead.read_kaggle_2014(address, subject_test, processes["samp_rate"])
            processesTest = processes
            processesTest["val_percentage"] = 0
            train_in, train_out, train_lat, seqs, \
            val_in, val_out, val_lat, val_seqs, \
            test_in, test_out, test_lat = SeizureDataRead.prepare_data(data, processesTest)
